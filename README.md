...
- **Diff review:** Open **Diff** from an agent conversation to review the folder's staged, unstaged, and untracked changes against HEAD. Switch between unified and split layouts; the view refreshes automatically as the checkout changes. Agents in the same folder share this checkout diff.
