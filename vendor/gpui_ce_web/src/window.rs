...
use crate::events::{
    ClickState, EventListenerHandle, TouchPointer, WebEventListeners, is_mac_platform,
};
use std::sync::Arc;
...
pub(crate) struct WebWindowInner {
    ...
    pub(crate) touch_pointer: Cell<Option<TouchPointer>>,
...
impl WebWindow {
    ...
    pub fn new(
        ...
        let renderer = WgpuRenderer::new_from_web_surface(context, surface, renderer_config)?;
